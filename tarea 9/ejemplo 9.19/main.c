...
El programa ordena de menor a mayor en función de la matricula, creando un
archivo de acceso directo compuesto por estructuras y ordenado de mayor a menor. */
