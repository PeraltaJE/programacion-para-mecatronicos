...
int main()
{
    ...
    do
    {
        ...
        else if (opcion == 2)
        {
            ...
            // Imprimir los numeros en la consola
            printf("Numeros generados: %d, %d, %d\n", numeros[0], numeros[1], numeros[2]);

            // Abrir el archivo en modo de escritura (anadir contenido al final)
            ...
            // Imprimir la fecha, hora y numeros en el archivo
        ...
        else if (opcion == 4) //cerrar archivo
        {
