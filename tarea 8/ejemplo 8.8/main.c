...
hospital en cada una de las categorias de condicion. */
{
    ...
    printf("Numero pacientes en condicion 1: %d", C1);
    printf("Numero pacientes en condicion 2: %d", C2);
    printf("Numero pacientes en condicion 3: %d", C3);
    printf("Numero pacientes en condicion 4: %d", C4);
    printf("Numero pacientes en condicion 5: %d", C5);
}
...
{
    int I;
    printf("Pacientes ingresados en estado de gravedad");
    for (I=0; I<T; I++)
    {
        if (A[I].con == 5)
        {
            printf("Nombre: %s\tTelefono: %s", A[I].nom, A[I].tel);
        }
    }
}
